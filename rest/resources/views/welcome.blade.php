                ...
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    ...
                    <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
									...
									<li class="scroll-to-section"><a href="{{url('/history')}}">purchase History</a></li>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								<h1 class="mb-10" style="color:#252525">What kind of Coffee and food we serve for you</h1>
								<p style="color:#252525">Who are in extremely love with eco friendly system.</p>
							</div>
						</div>
					</div>						
					<div class="row">
						...
						<div class="col-lg-4">
				<div class="card">
  <div class="card-img" style="background-image: url('/food/{{$food->image}}'); "></div>
  <div class="card-info">
    <p class="text-title">{{$food->foodtitle}}</p>
    <p class="text-body">{{$food->description}}</p>
  </div>
  <div class="card-footer">
  <span class="text-title">Lkr. {{ $food->attributes->max('price') }}</span>
